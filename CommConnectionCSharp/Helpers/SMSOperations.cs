...
namespace AMSMSService {
    public class SMSOperations {
        public static List<string> CommPorts = new List<string> { "COM1", "COM2", "COM3" };
        ...
        public int CountSMSmessages(SerialPort port) {
            ...
            try {
                ...
                //recievedData = ExecCommand(port, "AT+CPIN=\"0000\"", 300, "Sim PIN Failed ");
        ...
        public bool sendMsg(SerialPort port, string PhoneNo, string Message) {
            ...
            try {
                ...
                Logger.WriteLineToFile(string.Format("<sendMsg> An exception occured with Error {0}", ex.Message));
                return isSend;
            }
